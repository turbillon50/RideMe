...
import { IconCall, IconPin, IconStar, IconLightning } from '@/components/rm-icons';
...
export default function TripTrackingPage() {
  ...
  return (
    <main className="rm-app">
      <RideMap pickup={String(ride.origin_address)} dropoff={String(ride.destination_address)} eta="Llega en 3 min" />
      <header className="rm-app__top">
        ...
        <span className="rounded-full bg-[var(--rm-accent-muted)] px-3 py-1 text-xs font-semibold text-[var(--rm-accent)]">
          En camino
        </span>
      </header>

      <section className="rm-app__sheet">
        ...
        <div className="mb-4 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-[var(--rm-text-3)]">
              {ride.vehicle_make} {ride.vehicle_model} · {ride.plate_number}
            </p>
          </div>
        ...
        <div className="mb-4 space-y-2 text-sm">
          ...
          <div className="flex items-start gap-2">
            <IconPin size={14} className="mt-0.5 text-[var(--rm-text-3)]" />
