    ...
    <div className="min-h-screen bg-background pb-24 md:pl-20">
      ...
      <div className="px-4 py-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            <div className="flex items-center gap-3 px-4 py-3.5 border-b border-[rgba(255,255,255,0.04)]">
              <div className="w-2.5 h-2.5 rounded-full bg-[#00E5A8] flex-shrink-0" />
              <input
                type="text"
          ...
          >
            <div className="bg-[#111118] border border-[rgba(255,255,255,0.06)] rounded-2xl px-4 py-3.5">
              <div className="flex items-center gap-2 mb-2">
                <Calendar size={13} className="text-[#00E5A8]" />
            ...
            <div className="bg-[#111118] border border-[rgba(255,255,255,0.06)] rounded-2xl px-4 py-3.5">
              <div className="flex items-center gap-2 mb-2">
                <Clock size={13} className="text-[#00E5A8]" />
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-2xl font-black font-mono outline-none placeholder-[#2A2A3A] text-[#00E5A8]"
              />
            </div>
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 py-3.5 rounded-2xl border transition-all ${
                  paymentMethod === method
                    ? 'border-[#00E5A8] bg-[rgba(0,229,168,0.1)] text-white'
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#00E5A8] to-[#00D4AA] font-bold text-base disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {loading ? (
        ...
        <motion.div
          ...
          className="mt-4 bg-[rgba(0,229,168,0.06)] border border-[rgba(0,229,168,0.15)] rounded-2xl p-4 space-y-2"
        >
          <p className="text-xs font-semibold text-[#00E5A8]">¿Cómo funciona?</p>
          {[
            ...
            <div key={i} className="flex items-start gap-2 text-xs text-[#8B8B9E]">
              <div className="w-1.5 h-1.5 rounded-full bg-[#00E5A8] mt-1 flex-shrink-0" />
              {tip}
            </div>
          ))}
        </motion.div>
