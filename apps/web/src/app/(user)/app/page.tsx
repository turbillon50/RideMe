...
import { IconLightning, IconPin } from '@/components/rm-icons';
...
export default function PassengerHome() {
  ...
  return (
    <main className="rm-app">
      <RideMap pickup={pickup || 'Origen'} dropoff={destination || '¿A dónde vas?'} eta="—" />
      ...
      <form className="rm-app__sheet" onSubmit={ask}>
        <div className="rm-app__handle" />
        <h1 className="mb-4 text-[22px] font-bold tracking-tight">¿A dónde vas?</h1>

        <div className="mb-2 rm-field">
          <IconPin size={18} className="text-[var(--rm-text-3)]" />
          <input
            value={pickup}
        ...
        <div className="mb-4 flex items-center justify-between rounded-[18px] border border-[var(--rm-border)] bg-[var(--rm-surface-2)] px-3 py-3">
