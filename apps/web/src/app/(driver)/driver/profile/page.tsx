      ...
      <div className="px-4 py-6 space-y-5">
        {loading ? (
          ...
          <>
            ...
            >
              <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#00E5A8] to-[#00D4AA] flex items-center justify-center text-white font-black text-3xl mb-3 relative">
              ...
              <div className="flex items-center gap-4 mt-2">
                <div className="text-center">
                  <div className="font-mono font-black text-[#00E5A8]">{profile?.rating?.toFixed(1) ?? '5.0'}</div>
            ...
            >
              <div className="flex items-center gap-2 px-4 py-3 border-b border-[rgba(255,255,255,0.04)]">
                <Car size={14} className="text-[#00E5A8]" />
              ...
              <div className="px-4 py-3 space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#1A1A24] border border-[rgba(255,255,255,0.06)] rounded-xl px-3 py-2 text-sm outline-none focus:border-[rgba(0,229,168,0.4)]"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#1A1A24] border border-[rgba(255,255,255,0.06)] rounded-xl px-3 py-2 text-sm outline-none focus:border-[rgba(0,229,168,0.4)] font-mono tracking-widest"
                  />
                </div>
              </div>
            </motion.div>
            ...
            <motion.button
              ...
              onClick={handleSave}
              disabled={saving}
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-[#00E5A8] to-[#00D4AA] font-bold text-sm disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {saving ? (
            ...
            >
              ...
              {docItems.map((doc, i) => (
                <div key={doc.key} className={`flex items-center justify-between px-4 py-3.5 ${i < docItems.length - 1 ? 'border-b border-[rgba(255,255,255,0.04)]' : ''}`}>
                  ...
                  <button className="flex items-center gap-1.5 text-xs text-[#00E5A8] bg-[rgba(0,229,168,0.1)] rounded-xl px-3 py-1.5">
