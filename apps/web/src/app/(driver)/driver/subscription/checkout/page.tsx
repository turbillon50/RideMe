    ...
    <div className="min-h-screen bg-background md:pl-20">
      ...
      <div className="px-4 py-6 space-y-5 max-w-md mx-auto">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[rgba(0,229,168,0.2)] to-[rgba(0,212,170,0.1)] border border-[rgba(0,229,168,0.25)] rounded-2xl p-4"
        >
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#00E5A8] to-[#00D4AA] font-bold flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {loading ? (
